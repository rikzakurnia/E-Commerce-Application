...
public class OrderController {
	...
	public ResponseEntity<OrderDTO> orderProducts(@Valid @RequestBody CreditCardDTO creditCard, @PathVariable String email, @PathVariable Long cartId, @PathVariable String paymentMethod) {
		OrderDTO order = orderService.placeOrder(email, cartId, paymentMethod, creditCard);
